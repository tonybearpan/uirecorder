    ...
    function initRecorderDom(){
        ...
        function initToolsPannel(){
            ...
            function fixUirecorder(){                
                ...
                var bodyCmd = "var body = document.body;body.innerHTML = body.innerHTML +'"+styleStr+"';"
                eval(bodyCmd);
            };
        }
